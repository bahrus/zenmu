...
var test1 = (_a = [".myClass2>ul#myUL.myClass1", "li", "+li", ""], _a.raw = [".myClass2>ul#myUL.myClass1", "li", "+li", ""], zenCore_1.zen(_a, { myAttrib1: 'val1', myAttrib2: 42, myAttrib3: true }, 'Hello, ', 'World.'));
